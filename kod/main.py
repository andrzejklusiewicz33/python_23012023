...
# Dodaj do klasy metodę get_bmi która zwróci obliczone na podstawie pól BMI. Powołaj do życia obiekt tej klasy i wyświetl na konsoli obliczone BMI.
#
# class Player:
...
#             self.weight=weight
#         else:
#             raise Exception('Wzrost musi być wartością liczbową')
#     def get_bmi(self):
#         return round(self.weight/pow(self.height,2),2)
#
# p=Player(1.76,82)
...
timezone=-2
color=black
# Stwórz klasę Ustawienia która będzie posiadała słownik jako pole.
